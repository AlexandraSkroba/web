...
class Product(models.Model):
    name = models.CharField(max_length=255, verbose_name="Название игрушки")
    ...
    time_create = models.DateTimeField(auto_now_add=True, verbose_name="Дата выпуска")
...
class Category(models.Model):
    name = models.CharField(max_length=180, db_index=True, verbose_name="Тип игрушки")
    slug = models.SlugField(max_length=255, db_index=True, verbose_name="URL", unique=True)
