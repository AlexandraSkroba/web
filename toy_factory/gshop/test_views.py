...
class TestViewsModels(APITestCase):
    ...
    def test_product_not_empty_get(self):
        cat = Category.objects.create(name="mens", slug="mens")
        prod = Product.objects.create(name="Batman", slug="Batman", description="test", price=123.0, category=cat)
    ...
    def test_register_post(self):
        url = reverse_lazy('register')
        code = self.client.post(url, {"username": "ilya", "first_name": "ilya", "last_name": "protsko", "phone_number":
