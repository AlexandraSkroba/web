...
class TestOrders(APITestCase):
    def test_order_create_post(self):
        ...
        prod = Product.objects.create(name="margarita", slug="margarita", description="test", price=123.0, category=cat)
        ...
        code = self.client.post(url, {"first_name": "fedor", "second_name": "tarasenko", "email": "mymail@gmail.com",
